...
StepperDriver::StepperDriver()
{
  ...
  this->last_step_time = 0L;    // time stamp in ms of the last step taken
  this->number_of_steps = 0L;    // total number of steps for this motor
  this->dir_pin = 0;
  this->step_pin = 0;
  this->done = 0;
  this->running = false;
...
*/
void StepperDriver::setSpeed(float whatSpeed)
{
