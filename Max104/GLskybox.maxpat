...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 370.0, 166.0, 96.0, 24.0 ],
					"text" : "apply texture"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "d" ],
									"patching_rect" : [ 157.0, 162.5, 27.0, 21.0 ],
									"text" : "t d"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "a" ],
									"patching_rect" : [ 130.0, 162.5, 27.0, 21.0 ],
									"text" : "t a"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 130.0, 132.5, 73.0, 21.0 ],
									"text" : "sel 28 29"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 130.0, 232.5, 85.0, 19.0 ],
									"text" : "ui_keyup $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "d" ],
									"patching_rect" : [ 77.0, 162.5, 27.0, 21.0 ],
									"text" : "t d"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "a" ],
									"patching_rect" : [ 50.0, 162.5, 27.0, 21.0 ],
									"text" : "t a"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "bang", "bang", "" ],
									"patching_rect" : [ 50.0, 132.5, 73.0, 21.0 ],
									"text" : "sel 28 29"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 130.0, 100.0, 50.0, 21.0 ],
									"text" : "keyup"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 232.5, 68.0, 19.0 ],
									"text" : "ui_key $1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 85.0, 311.5, 25.0, 25.0 ]
								}
...
,
					"patching_rect" : [ 139.0, 63.5, 93.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 155.0, 97.0, 76.0, 19.0 ],
					"text" : "anim_reset"
				}
...
,
					"patching_rect" : [ 6.0, 199.0, 102.0, 20.0 ],
					"saved_object_attributes" : 					{
						"fontname" : "Arial",
						"default_fontsize" : 12.0,
						"description" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 29.0, 545.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 365.0, 239.0, 117.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 365.0, 265.0, 117.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 156.0, 162.0, 96.5, 20.0 ],
					"text_width" : 71.5
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 325.0, 63.5, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 325.0, 106.0, 107.0, 20.0 ],
					"text" : "pak f f f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 344.0, 166.0, 24.5, 24.5 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 344.0, 198.0, 187.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 343.0, 312.5, 90.0, 20.0 ],
					"text_width" : 61.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 325.0, 133.5, 180.0, 20.0 ],
					"text_width" : 67.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 325.0, 341.0, 73.0, 20.0 ],
					"text" : "jit.gl.skybox"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 7.0, 96.0, 73.0, 20.0 ],
					"text" : "qmetro 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 139.0, 127.0, 149.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 139.0, 190.0, 133.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 7.0, 128.0, 73.0, 20.0 ],
					"text" : "t b erase"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 7.0, 167.0, 73.0, 20.0 ],
					"text" : "jit.gl.render"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 6.0, 224.0, 86.0, 34.0 ],
					"text" : "jit.window sky @sync 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.0, 55.0, 108.147247, 210.0 ],
					"rounded" : 30
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 3.0, 2.0, 550.0, 48.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 70.5, 157.0, 16.5, 157.0 ],
					"source" : [ "obj-12", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 353.5, 229.0, 444.5, 229.0 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 353.5, 229.5, 334.5, 229.5 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 334.5, 93.0, 422.5, 93.0 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 334.5, 93.0, 378.5, 93.0 ],
					"source" : [ "obj-19", 0 ]
				}
