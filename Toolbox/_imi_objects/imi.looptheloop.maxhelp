...
,
		"rect" : [ 2.0, 44.0, 562.0, 522.0 ],
		"bglocked" : 0,
		"defrect" : [ 2.0, 44.0, 562.0, 522.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 344.0, 217.0, 141.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 389.0, 157.0, 142.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 201.0, 136.0, 74.0, 20.0 ],
					"text" : "r frameconv"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 403.0, 180.0, 143.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 374.0, 131.0, 122.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 97.0, 136.0, 99.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 9.0, 136.0, 84.0, 18.0 ],
					"text" : "bang, gettime"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 9.0, 484.0, 80.0, 35.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 9.0, 106.0, 63.0, 20.0 ],
					"text" : "qmetro 40"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1.510893, 30.332657, 556.0, 36.0 ],
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 412.5, 209.5, 475.5, 209.5 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-116", 0 ],
					"hidden" : 0,
					"midpoints" : [ 106.5, 165.5, 18.5, 165.5 ],
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-116", 0 ],
					"hidden" : 0,
					"midpoints" : [ 210.5, 165.0, 18.5, 165.0 ],
					"source" : [ "obj-36", 0 ]
				}
