...
,
					"patching_rect" : [ 31.5, 332.0, 141.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 139.0, 396.0, 145.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 428.0, 143.0, 27.0 ],
					"text" : "fxwdmxusbpro"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 242.0, 125.0, 22.0 ],
					"text" : "pak 0 0 0 0 0"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "/Applications/Max 6.1/packages/IMIpatches/patchers/Toolbox/communication/Enttec_fxwdmxusbpro",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
