...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 185.0, 560.0, 35.0, 18.0 ],
					"text" : "step#"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 31.625, 37.0, 374.0, 50.0 ],
					"text" : "This example uses weight tables as rhythmic/step probabilities and a genetic crossover to generate new weight tables from two previous tables — parentA and parentB. "
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 441.0, 57.0, 276.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 561.0, 15.0, 150.0, 40.200001 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 166.0, 675.0, 142.5, 12.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 308.333313, 590.5, 135.0, 29.0 ],
					"text" : "< Generate new offspring at the end of the bar."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 31.625, 15.0, 315.25, 22.0 ],
					"text" : "GA (Crossover) + Weight Table"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 248.5, 355.0, 191.5, 21.0 ],
					"text" : "Offspring / Weights table "
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 424.0, 152.0, 63.0, 21.0 ],
					"text" : "Parent B"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 194.5, 152.0, 63.0, 21.0 ],
					"text" : "Parent A"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 155.0, 311.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 237.5, 376.0, 180.0, 73.0 ],
					"setminmax" : [ 0.0, 1.0 ],
					"setstyle" : 1,
					"size" : 7
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 315.333313, 560.0, 48.0, 18.0 ],
					"text" : "deferlow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 103.5, 435.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 228.5, 710.0, 95.0, 20.0 ],
					"preset_data" : [ 						{
							"number" : 1,
							"data" : [ 11, "obj-16", "multislider", "list", 1.0, 0.322581, 0.935484, 0.354839, 1.0, 0.354839, 0.634409, 11, "obj-17", "multislider", "list", 1.0, 0.451613, 0.16129, 0.978495, 0.225806, 0.978495, 0.322581, 5, "<invalid>", "live.gain~", "float", -7.652698, 5, "obj-13", "toggle", "int", 0, 5, "obj-15", "number", "int", 210, 5, "obj-19", "slider", "float", 100.0, 11, "obj-22", "multislider", "list", 1.0, 0.322581, 0.935484, 0.354839, 0.225806, 0.978495, 0.634409 ]
						}
 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 276.0, 587.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 276.0, 560.0, 32.5, 18.0 ],
					"text" : "sel 7"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 248.5, 116.0, 345.0, 39.0 ],
					"text" : "compound time signatures (7/4) "
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 13.75, 311.0, 91.0, 55.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 448.333313, 485.0, 128.0, 29.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 218.0, 560.0, 50.0, 19.0 ],
					"text" : "6"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 308.333313, 465.0, 115.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 308.333313, 485.0, 140.0, 30.0 ],
					"size" : 101.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 98.333313, 365.0, 50.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 48.333313, 365.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 48.333313, 400.0, 69.0, 21.0 ],
					"text" : "metro"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 166.0, 530.0, 102.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 166.0, 653.0, 142.5, 20.0 ]
				}
...
,
					"patching_rect" : [ 166.0, 619.0, 54.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 165.5, 710.0, 48.75, 48.75 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 425.0, 170.0, 223.0, 95.0 ],
					"setminmax" : [ 0.0, 1.0 ],
					"setstyle" : 1,
					"size" : 7
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 194.5, 170.0, 223.0, 95.0 ],
					"setminmax" : [ 0.0, 1.0 ],
					"setstyle" : 1,
					"size" : 7
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 425.0, 280.0, 61.0, 19.0 ],
					"text" : "prepend B"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 194.5, 280.0, 61.0, 19.0 ],
					"text" : "prepend A"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 194.0, 335.0, 84.0, 18.0 ],
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 263.333344, 746.0, 443.916656, 746.0, 443.916656, 550.0, 324.833313, 550.0 ],
					"source" : [ "obj-10", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 57.833313, 470.0, 175.5, 470.0 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 317.833313, 524.0, 258.5, 524.0 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 203.5, 369.5, 247.0, 369.5 ],
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 285.5, 621.0, 602.5, 621.0, 602.5, 308.0, 203.5, 308.0 ],
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 434.5, 321.5, 203.5, 321.5 ],
					"source" : [ "obj-9", 0 ]
				}
...
, 			{
				...
				"patcherrelativepath" : "../../../../../../../../Applications/Max6/patches/OI_framework/Libs/Olib/MIDI",
				"type" : "JSON",
				"implicit" : 1
			}
 ]
