...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 411.0, 356.0, 89.0, 20.0 ],
					"presentation_rect" : [ 39.0, 356.0, 0.0, 0.0 ],
					"rounded" : 20.0,
					"text" : "hap codec",
					"texton" : "Stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 411.0, 358.0, 46.0, 18.0 ],
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 411.0, 358.0, 64.0, 15.0 ],
					"presentation_rect" : [ 37.0, 356.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 6.0, 297.0, 102.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 324.848022, 356.0, 84.0, 20.0 ],
					"rounded" : 20.0,
					"text" : "video mask",
					"texton" : "Stop"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 236.848022, 356.0, 84.0, 20.0 ],
					"rounded" : 20.0,
					"text" : "video blend",
					"texton" : "Stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 231.848022, 356.0, 83.0, 16.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 103.848022, 356.0, 128.0, 20.0 ],
					"rounded" : 20.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 159.347992, 95.251862, 109.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 101.848022, 356.0, 136.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 361.848022, 356.0, 44.0, 17.0 ],
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 283.848022, 356.0, 124.0, 16.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 168.847992, 121.0, 152.539764, 121.0 ],
					"source" : [ "obj-13", 0 ]
				}
