...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 21.0, 190.0, 125.0, 27.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 232.0, 68.0, 128.0, 48.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 21.0, 68.0, 200.0, 27.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 21.0, 29.0, 166.0, 25.0 ],
...
,
					"patching_rect" : [ 187.0, 595.5, 78.0, 27.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 505.0, 497.0, 192.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 531.0, 551.0, 167.0, 23.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 5.0, 22.0, 191.0, 19.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 5.0, 7.0, 247.0, 19.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 5.0, 37.0, 194.0, 19.0 ],
...
,
					"patching_rect" : [ 656.0, 15.0, 49.0, 18.0 ],
					"saved_object_attributes" : 					{
						"fontface" : 0,
						"fontsize" : 12.0,
						"default_fontface" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 467.0, 522.0, 231.0, 27.0 ],
					"text" : "jit.matrix video 4 char 10 10"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 586.0, 603.5, 117.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 586.0, 603.5, 102.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 586.0, 603.5, 44.0, 17.0 ],
					"text" : "pcontrol"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 371.0, 201.5, 88.0, 21.0 ],
									"text" : "dim 320 240"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 371.0, 146.5, 180.0, 48.0 ],
									"text" : "4 planes (ARGB)\n320 x 240 dimension"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 243.0, 41.5, 36.0, 21.0 ],
									"text" : "start"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 202.0, 41.5, 35.5, 21.0 ],
									"text" : "stop"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 198.0, 146.5, 160.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 90.0, 41.5, 107.0, 21.0 ],
									"text" : "read dozer.mov"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 8.0, 41.5, 76.0, 23.0 ],
									"text" : "qmetro 40"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 8.0, 90.5, 136.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 371.0, 231.5, 75.0, 21.0 ],
									"text" : "dim 10 10"
								}
...
,
					"patching_rect" : [ 5.0, 595.5, 178.0, 27.0 ],
					"saved_object_attributes" : 					{
						"fontface" : 0,
						"fontsize" : 18.0,
						"default_fontface" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 44.0, 383.0, 317.0 ],
					"text" : "A digital image is represented as a matrix with numbers representing each pixel.\n\nA digital video is \"moving\" images. In jitter, \nit's a collection of changing matrices.\n\nTypically, images are saved with 8 bits, so there are 256 values to choose from (0-255).\n\nColours are represented in ARGB where A is the Alpha channel (transparency), and \nRGB means Red, Green, Blue.\n\nThus to represent a colour image, it is necessary with 4 values for each pixel."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 130.0, 501.0, 334.0, 48.0 ],
					"text" : "In Jitter, colour images are represented \nin 2-dimensional matrices with 4 planes :"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.0, 367.0, 337.0, 119.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 442.0, 276.0, 242.0, 183.0 ]
				}
