...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 127.0, 295.0, 88.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 62.0, 294.0, 79.0, 17.0 ],
					"rounded" : 20.0,
					"text" : "IMI_texture",
					"texton" : "Stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 126.0, 295.0, 94.0, 18.0 ],
					"presentation_rect" : [ 57.0, 294.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 164.0, 295.0, 53.0, 20.0 ],
					"presentation_rect" : [ 98.0, 294.0, 0.0, 0.0 ],
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 25.0, 180.0, 71.0, 20.0 ],
					"text" : "jit.gl.handle"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 222.0, 295.0, 152.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 65.0, 231.0, 79.0, 17.0 ],
					"rounded" : 20.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 217.0, 295.0, 158.0, 18.0 ],
...
,
					"patching_rect" : [ 10.0, 234.0, 102.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 58.0, 152.0, 45.0, 20.0 ],
					"text" : "s draw"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 10.0, 259.670532, 98.0, 20.0 ],
					"text" : "jit.window mstex"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 10.10907, 124.341187, 67.0, 20.0 ],
					"text" : "t b erase b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 10.10907, 205.670532, 70.0, 20.0 ],
					"text" : "jit.gl.render"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 3.0, 2.0, 245.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.0, 53.0, 116.147247, 234.0 ],
					"rounded" : 30
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 140.0, 249.0, 179.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 140.0, 82.0, 135.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 258.0, 295.0, 53.0, 20.0 ],
					"text" : "pcontrol"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 43.60907, 163.905884, 19.60907, 163.905884 ],
					"source" : [ "obj-18", 1 ]
				}
