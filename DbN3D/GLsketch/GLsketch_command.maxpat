...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 265.0, 359.0, 162.0, 24.0 ],
					"presentation_rect" : [ 270.0, 362.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 222.0, 363.0, 40.0, 20.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 170.0, 363.0, 40.0, 20.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 119.0, 363.0, 40.0, 20.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 67.0, 363.0, 40.0, 20.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 67.0, 388.0, 174.0, 20.0 ],
					"text" : "pak 1. 1. 1. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 67.0, 414.0, 229.0, 32.0 ],
					"text" : "reset, glcolor 0 0 0 1, gltranslate $1 $2 0, glscale $3 $4 0, plane 3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 112.0, 60.0, 116.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 60.0, 233.0, 44.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 108.0, 231.0, 116.0, 24.0 ],
					"text" : "rotation (0-360)"
				}
...
,
					"patching_rect" : [ 560.0, 267.0, 102.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 341.0, 322.0, 135.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 240.0, 322.0, 95.0, 21.0 ],
					"text" : "glscale $1 $2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 115.0, 322.0, 116.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 60.0, 263.0, 419.0, 53.0 ],
					"text" : "reset, glmatrixmode modelview, glpushmatrix, glrotate $1 0 0 1, glcolor 0 1 0 1, glbegin triangles, glvertex -0.5 -0.5, glvertex 0 0.5, glvertex 0.5 -0.5, glend, glpopmatrix"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 4.0, 439.0, 607.0, 48.0 ],
									"text" : "points, lines, line_loop, line_strip, triangles,  tri_strip, tri_fan, tri_grid, quads, quad_strip, quad_grid, polygon"
								}
...
,
					"patching_rect" : [ 590.0, 454.0, 100.0, 23.0 ],
					"saved_object_attributes" : 					{
						"default_fontsize" : 14.0,
						"fontname" : "Arial",
						"description" : "",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 13.0, 11.0, 334.0, 88.0 ],
									"text" : "reset\nglcolor [color in RGBA] value betwwen 0. and 1.\nglbegin [GL primitive]\nglvertex [x, y  and  z] value  between 0. and 1. \nglend"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 8.0, 9.0, 338.0, 93.928284 ],
									"rounded" : 34,
...
,
					"patching_rect" : [ 511.0, 454.0, 73.0, 23.0 ],
					"saved_object_attributes" : 					{
						"default_fontsize" : 14.0,
						"fontname" : "Arial",
						"description" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 8.0, 454.0, 331.0, 23.0 ],
					"text" : "jit.gl.sketch command @scale 0.6 @line_width 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 62.0, 59.0, 45.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 8.0, 60.0, 47.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 8.0, 125.0, 465.0, 37.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 8.0, 93.0, 73.0, 23.0 ],
					"text" : "pak 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 34.0, 175.0, 366.0, 37.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 3.0, 29.0, 478.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 560.0, 294.0, 119.0, 20.0 ],
					"text" : "jit.window command"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 583.0, 62.0, 60.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 608.0, 148.0, 46.0, 20.0 ],
					"text" : "s draw"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 560.0, 216.0, 65.0, 36.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 560.0, 62.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 560.0, 92.0, 65.0, 20.0 ],
					"text" : "qmetro 20"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 560.0, 121.0, 67.0, 20.0 ],
					"text" : "t b erase b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 560.0, 175.0, 131.0, 34.0 ],
					"text" : "jit.gl.render command @ortho 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 551.0, 53.0, 145.147247, 267.0 ],
					"rounded" : 30
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 3.0, 2.0, 694.0, 48.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 593.5, 160.5, 569.5, 160.5 ],
					"source" : [ "obj-26", 1 ]
				}
